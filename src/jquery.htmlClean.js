...
(function ($) {
    ...
    var tagAllowEmpty = ["th", "td", "en-media", "en-todo"];
    ...
    var tagSelfClosing = ["en-media", "en-todo", "area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta", "param", "source", "track", "wbr"];
